    ...
    <div id="header">
      ...
      <div className="container">
        ...
        <ul id="subnav">
          ...
          <li><a href="#band-links">Band Links</a>&nbsp;|</li>
          <li>
          ...
          <li className="featured_item">
            ...
            <div className="item_info_column">
              ...
              <h4>
                ...
                Category: Music | Added: Apr-28-2026 in <a href="#videos">Entertainment</a>, <a href="#music">Music</a><br />
                Tags: music, liveleak, video
              </h4>
          ...
          <li>
            ...
            <div className="item_info_column">
              ...
              <h4>
                ...
                Added: pending in <a href="#videos">Videos</a><br />
                Tags: video
              </h4>
            </div>
          </li>
          ...
          <li key={video.id}>
            ...
            <div className="item_info_column">
              ...
              <h4>
                ...
                Comments: <Link href={`/video/${video.id}`}>{video.comment_count || 0}</Link> |
                Views: {video.views || 0} |
                Votes: {video.likes || 0} |
                Shared: {video.shares || 0}<br />
                Added: {formatDate(video.created_at)} in <a href="#videos">Videos</a><br />
                Tags: video, music
              </h4>
        ...
        <ul>
          {threads.length === 0 && (
            <li>
              ...
              <span>Post a thread in the forum.</span>
            </li>
          )}
